...
- Template-drift gate for audit, validate, and inspect so exact bundled templates or unresolved placeholders cannot be mistaken for customized harness docs.
